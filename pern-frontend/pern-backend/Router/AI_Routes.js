...
import { generateArticle, generateBlog, generateImage, Remove_background, removeObejct_image, resume_checker } from "../Controller/Ai_controller.js";
...
AI_Routes.post('/review-resume',upload.single('resume'),Auth,resume_checker)
