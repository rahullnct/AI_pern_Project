  ...
  return (
    <div className='remove_Object_conatiner'>
     ...
     <form className='first_object_container' onSubmit={submithandler}>
       <h2 className='first_object_heading'><Sparkle size={20}/>Obejct Removal</h2>
     ...
     <div className='second_article_container'>
      <h2 className='second_article_heading'><Scissors size={25}/>Remove Objct</h2>
       {
        objectRemoveImage ? (<div className='article_content'>
          Object removal
        </div>) :
        (<div className='no_article_content'>
        <Scissors size={20}/>
         <p className='no_article'>Describe which object you want to remove and click on 'Remove Object' to get started</p>
        </div>)
       }
      </div>
     </div>
